...
#SBATCH --time=6:00:00
#SBATCH --job-name=train_primate_250M_8k_tokenizer_15x1_32k
#SBATCH --output=train_primate_250M_8k_tokenizer_15x1_32k_%A_%a.out
#SBATCH --array=0-1%1
...
CONFIG_FILE=${CONFIG_FILE:-"./train_configs/primate_250M_8k_tokenizer_15x1_32k.toml"}
