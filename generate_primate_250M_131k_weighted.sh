...
#SBATCH --time=1:00:00
#SBATCH --job-name=generate_primate_250M_131k_weighted
#SBATCH --output=generate_primate_250M_131k_weighted_%A_%a.out
#SBATCH --array=0
...
CONFIG_FILE=${CONFIG_FILE:-"./train_configs/primate_250M_131k_weighted.toml"}

srun torchrun --nnodes $SLURM_NNODES --nproc_per_node 4 --max_restarts 1 --node_rank $SLURM_NODEID --rdzv_id 101 --rdzv_backend c10d --rdzv_endpoint "$MASTER_ADDR:$MASTER_PORT" ./generate.py --config ${CONFIG_FILE} --ckpt "outputs/primate_250M_131k_weighted/checkpoint/step-25200"
