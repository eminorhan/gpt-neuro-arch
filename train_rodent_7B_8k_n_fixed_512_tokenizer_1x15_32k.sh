...
#SBATCH --time=6:00:00
#SBATCH --job-name=train_rodent_7B_8k_n_fixed_512_tokenizer_1x15_32k
#SBATCH --output=train_rodent_7B_8k_n_fixed_512_tokenizer_1x15_32k_%A_%a.out
#SBATCH --array=0
...
CONFIG_FILE=${CONFIG_FILE:-"./train_configs/rodent_7B_8k_n_fixed_512_tokenizer_1x15_32k.toml"}
