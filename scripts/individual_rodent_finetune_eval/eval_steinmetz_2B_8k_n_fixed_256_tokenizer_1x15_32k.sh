...
#SBATCH --time=6:00:00
#SBATCH --job-name=eval_steinmetz_2B_8k_n_fixed_256_tokenizer_1x15_32k_pretrained
#SBATCH --output=eval_steinmetz_2B_8k_n_fixed_256_tokenizer_1x15_32k_pretrained_%A_%a.out
...
CONFIG_FILE=${CONFIG_FILE:-"./train_configs/finetune_individual_rodent/steinmetz_2B_8k_n_fixed_256_tokenizer_1x15_32k.toml"}
CHECKPOINT_DIR="./outputs/steinmetz_2B_8k_n_fixed_256_tokenizer_1x15_32k_pretrained/checkpoint"
...
srun torchrun --nnodes $SLURM_NNODES --nproc_per_node 4 --max_restarts 1 --node_rank $SLURM_NODEID --rdzv_id 101 --rdzv_backend c10d --rdzv_endpoint "$MASTER_ADDR:$MASTER_PORT" ./evaluate.py --config ${CONFIG_FILE} --ckpt ${CKPT_PATH} --eval_steps 1000
