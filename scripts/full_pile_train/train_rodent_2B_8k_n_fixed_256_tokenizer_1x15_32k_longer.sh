...
#SBATCH --time=6:00:00
#SBATCH --job-name=train_rodent_2B_8k_n_fixed_256_tokenizer_1x15_32k_longer
#SBATCH --output=train_rodent_2B_8k_n_fixed_256_tokenizer_1x15_32k_longer_%A_%a.out
#SBATCH --array=0-29%1
