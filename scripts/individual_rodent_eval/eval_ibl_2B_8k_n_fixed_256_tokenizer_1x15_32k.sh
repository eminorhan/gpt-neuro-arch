...
CONFIG_FILE=${CONFIG_FILE:-"./train_configs/individual_rodent/ibl_2B_8k_n_fixed_256_tokenizer_1x15_32k.toml"}
CHECKPOINT_DIR="./outputs/ibl_2B_8k_n_fixed_256_tokenizer_1x15_32k/checkpoint"
