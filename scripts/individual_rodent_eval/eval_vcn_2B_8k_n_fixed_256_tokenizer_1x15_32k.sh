...
#SBATCH --time=6:00:00
#SBATCH --job-name=eval_vcn_2B_8k_n_fixed_256_tokenizer_1x15_32k
#SBATCH --output=eval_vcn_2B_8k_n_fixed_256_tokenizer_1x15_32k_%A_%a.out
...
CONFIG_FILE=${CONFIG_FILE:-"./train_configs/individual_rodent/vcn_2B_8k_n_fixed_256_tokenizer_1x15_32k.toml"}
CHECKPOINT_DIR="./outputs/vcn_2B_8k_n_fixed_256_tokenizer_1x15_32k/checkpoint"
