...
#SBATCH --time=6:00:00
#SBATCH --job-name=eval_chen_2B_8k_n_fixed_256_tokenizer_1x15_32k_pretrained
#SBATCH --output=eval_chen_2B_8k_n_fixed_256_tokenizer_1x15_32k_pretrained_%A_%a.out
...
CONFIG_FILE=${CONFIG_FILE:-"./train_configs/finetune_individual_primate/chen_2B_8k_n_fixed_256_tokenizer_1x15_32k.toml"}
CHECKPOINT_DIR="./outputs/chen_2B_8k_n_fixed_256_tokenizer_1x15_32k_pretrained/checkpoint"
