...
#SBATCH --time=3:00:00
#SBATCH --job-name=eval_primate_250M_8k_n_fixed_256_tokenizer_1x15_16k
#SBATCH --output=eval_primate_250M_8k_n_fixed_256_tokenizer_1x15_16k_%A_%a.out
...
CONFIG_FILE=${CONFIG_FILE:-"./train_configs/primate_250M_8k_n_fixed_256_tokenizer_1x15_32k.toml"}
CHECKPOINT_DIR="./outputs/primate_250M_8k_n_fixed_256_tokenizer_1x15_32k/checkpoint"
