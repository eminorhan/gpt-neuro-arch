...
#SBATCH --time=6:00:00
#SBATCH --job-name=eval_rodent_2B_8k_n_fixed_256_tokenizer_1x15_32k_longer
#SBATCH --output=eval_rodent_2B_8k_n_fixed_256_tokenizer_1x15_32k_longer_%A_%a.out
...
CONFIG_FILE=${CONFIG_FILE:-"./train_configs/rodent_2B_8k_n_fixed_256_tokenizer_1x15_32k_longer.toml"}
