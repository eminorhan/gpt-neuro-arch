...
#SBATCH --time=6:00:00
#SBATCH --job-name=finetune_steinmetz_2B_8k_n_fixed_256_tokenizer_1x15_32k
#SBATCH --output=finetune_steinmetz_2B_8k_n_fixed_256_tokenizer_1x15_32k_%A_%a.out
#SBATCH --array=0
