...
#SBATCH --time=6:00:00
#SBATCH --job-name=eval_willett_2B_8k_n_fixed_256_tokenizer_1x15_16k
#SBATCH --output=eval_willett_2B_8k_n_fixed_256_tokenizer_1x15_16k_%A_%a.out
...
CHECKPOINT_DIR="./outputs/willett_2B_8k_n_fixed_256_tokenizer_1x15_32k/checkpoint"
