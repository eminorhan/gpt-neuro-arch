...
#SBATCH --time=6:00:00
#SBATCH --job-name=train_willettchurchlandmakin_1b_131k
#SBATCH --output=train_willettchurchlandmakin_1b_131k_%A_%a.out
#SBATCH --array=0
...
CONFIG_FILE=${CONFIG_FILE:-"./train_configs/willettchurchlandmakin_1b_131k.toml"}
