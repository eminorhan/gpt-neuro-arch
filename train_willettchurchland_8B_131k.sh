...
#SBATCH --time=6:00:00
#SBATCH --job-name=train_willettchurchland_8b_131k
#SBATCH --output=train_willettchurchland_8b_131k_%A_%a.out
#SBATCH --array=0-9
...
CONFIG_FILE=${CONFIG_FILE:-"./train_configs/willettchurchland_8b_131k.toml"}
