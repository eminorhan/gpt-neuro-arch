...
#SBATCH --time=6:00:00
#SBATCH --job-name=eval_rodent_870M_8k_n_fixed_256_tokenizer_1x15_32k
#SBATCH --output=eval_rodent_870M_8k_n_fixed_256_tokenizer_1x15_32k_%A_%a.out
...
CONFIG_FILE=${CONFIG_FILE:-"./train_configs/rodent_870M_8k_n_fixed_256_tokenizer_1x15_32k.toml"}
CHECKPOINT_DIR="./outputs/rodent_870M_8k_n_fixed_256_tokenizer_1x15_32k/checkpoint"
