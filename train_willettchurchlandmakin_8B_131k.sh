...
#SBATCH --nodes=32
#SBATCH --exclude=arch[11,13,40]
#SBATCH --cpus-per-task=288
#SBATCH --ntasks-per-node=1
#SBATCH --gpus-per-node=4
#SBATCH --time=6:00:00
#SBATCH --job-name=train_willettchurchlandmakin_8b_131k
#SBATCH --output=train_willettchurchlandmakin_8b_131k_%A_%a.out
#SBATCH --array=0-9
...
CONFIG_FILE=${CONFIG_FILE:-"./train_configs/willettchurchlandmakin_8b_131k.toml"}
